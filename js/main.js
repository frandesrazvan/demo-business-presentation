...
const translations = {
  ro: {
    ...
    testimonialAuthor: '- John Smith, CTO, BigCo',
...
function setLanguage(lang) {
  ...
  if (testimonial) testimonial.textContent = t.testimonial1;
  // Contact
  ...
  // Testimonial author
  const testimonialAuthor = document.querySelector('.testimonial span');
  if (testimonialAuthor) testimonialAuthor.textContent = t.testimonialAuthor;
